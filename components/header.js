  ...
  return (
    <header className="px-5 border-b h-header flex items-center justify-between sticky top-0 bg-white z-30">
      ...
      <div className="flex items-center space-x-5">
        ...
        <Link href="/signup">
          <a className={`text-[14px] uppercase bg-primary1 py-[8px] px-[20px] rounded-md font-semibold whitespace-nowrap transition duration-100 ease-in-out hover:brightness-90`}
          >
            Sign up free
          </a>
        </Link>
