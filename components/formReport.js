...
// Data
import dataForm from '../fakeData/formReport.json'
import Button from './templates/button'

export default function FormReport({ className }) {
  ...
  const handleSubmit = e => {
    ...
    let errors = []
      ...
      formData.append('pickupurl', e.target.pickupurl.value)
      ...
      fetch(`${WP_API_URL}/contact-form-7/v1/contact-forms/88/feedback`, options)
      .then(res => res.json())
      .then(data => {
