...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1184px] mx-auto px-5 py-5 md:py-10 text-center">
      ...
      <div className="max-w-[1184px] mx-auto p-5 text-center">
      ...
      <div className="max-w-[1184px] mx-auto grid lg:grid-cols-3 gap-5 md:gap-10 py-10 md:py-20 px-5">
      {
        pricing.map( p => (
