  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-5 py-5 md:py-10 max-w-[780px]">
        <h1 className="text-[26px] md:text-[32px] mb-[20px]">Report a Violation - {SITE_NAME} Trust Center</h1>
        <h2 className="text-[28px] md:text-[38px] mb-[30px] leading-tight">Please use the form below to report a violation or an account you think we should review.</h2>
